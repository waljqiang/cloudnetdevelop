...
CREATE TABLE `cnldev_users` (
  ...
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '姓名',
  `idcard` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '身份证',
  `enterprise` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '企业名称',
  `enterprise_des` text DEFAULT NULL COMMENT '企业描述',
  `enterprisecode` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '全国统一信用码',
